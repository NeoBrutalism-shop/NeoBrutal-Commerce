...
test('composed runtime keeps transaction and licensing backends replaceable',()=>{
  ...
  assert.equal(runtime.version,'0.9.0-rc.1');assert.equal(runtime.commerce.kind,'commerce');assert.equal(runtime.licensing.kind,'licensing');assert.equal(Object.isFrozen(runtime),true);
});
