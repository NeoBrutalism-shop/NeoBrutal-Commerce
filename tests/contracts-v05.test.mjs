...
test('composed runtime keeps transaction and licensing backends replaceable',()=>{
  ...
  assert.equal(runtime.version,'1.0.0');assert.equal(runtime.commerce.kind,'commerce');assert.equal(runtime.licensing.kind,'licensing');assert.equal(Object.isFrozen(runtime),true);
});
