...
const required=[
  ...
  'tests/commerce-v02.spec.mjs','tests/commerce-v03.spec.mjs','tests/commerce-v04.spec.mjs','tests/commerce-v06.spec.mjs',
...
console.log(`NeoBrutal Commerce v0.6.0 checks passed · ${(totalBytes/1024).toFixed(1)} KiB CSS · ${components.length} component stylesheets · ${storefrontRoutes.length} production routes · lifecycle contracts + actions + EDD/licensing bridges + ownership renderers`);
